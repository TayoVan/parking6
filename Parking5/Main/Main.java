...
public class Main {
    public static void main(String[] args) {
        ...
        scanner.nextLine();
        Manager manager = new Manager(managerName, salary);
        ...
        scanner.nextLine();
        Cashier cashier = new Cashier(cashierName, salary);
        ...
        while (!exit) {
            ...
            switch (choice) {
                case 1:
                    ...
                    Driver driver = new Driver(driverName, car);

                    CurrentDriverHolder.setDriver(driver);
                    break;
                case 2:
                    Driver currentDriver = CurrentDriverHolder.getDriver();
                    if (currentDriver != null) {
                        ParkingTicket ticket = parkingLot.parkVehicle(currentDriver.getVehicle());
                ...
                case 3:
                    ...
                    if (ticketToCheck != null) {
                        boolean paymentConfirmed = cashier.checkPayment(ticketToCheck);
